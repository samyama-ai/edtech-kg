...
MATCH (p:Programme)-[:PREPARES_FOR]->(anchor1:Occupation)
WHERE anchor1.soc_code = "15-1252"
...
WHERE anchor1.unitid = "100654" AND p.cip_code = "11.0101"
...
MATCH (p:Programme)-[:PREPARES_FOR]->(anchor1:Occupation)
WHERE anchor1.soc_code = "29-1141"
RETURN p.cip_code, p.name;
...
MATCH (downstream:Course)-[:REQUIRES*]->(anchor1:Course)
...
WHERE anchor1.ncessch = "510126000341" AND c.url = "https://catalog.pwcs.edu/agriculture-food-and-natural-resources/landscaping-1"
...
MATCH (unlocked:Course)-[:REQUIRES*]->(anchor1:Course)
WHERE anchor1.url = "https://catalog.pwcs.edu/agriculture-food-and-natural-resources/landscaping-1"
